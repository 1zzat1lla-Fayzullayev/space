      ...
      >
        ...
        <ul className="max-w-[90%] mx-auto text-white">
          ...
          <div className="dive-drope">
            <li onClick={()=> setDrp((prev)=>!prev)} className="py-[10px] cursor-pointer hover:text-[#CBFB45] transition-colors text-[15px] font-light font-Apfel">
              Socials <span>
              <span className="lft bg-white w-[14px] h-[2px] rounded-full block"></span>
              <span className="rgt bg-white w-[14px] h-[2px] rounded-full block"></span>
